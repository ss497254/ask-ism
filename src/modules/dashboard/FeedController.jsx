    ...
    return (
        <div className="w-full" ref={ref}>
            <div
                ...
                className="scrollremove flex flex-row h-6.5 overflow-x-scroll gap-2 py-2 border-b border-gray-300 dark:border-gray-800 px-2 xl:-mt-4"
                style={{ width }}
            >
...
const Page = ({ cursor, isOnlyPage, isLastPage, onLoadMore }) => {
    ...
    const data = [
        ...
        },
        {
            ...
            tags: ["adsf", "asdf", "234"],
            User: { displayName: "adsf", avatarUrl: "/img/male-1a.jpg" },
        },
        {
            id: 523,
            statement:
