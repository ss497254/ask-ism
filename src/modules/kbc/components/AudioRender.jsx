...
const MyAudio = ({ volume, onRef, ...props }) => {
...
export const AudioRender = () => {
    ...
    return (
        <>
            ...
            >
                <div
                    className={`flex p-8 rounded m-auto bg-primary-700 flex-col`}
                >
                    <div className={`flex text-center mb-4 text-primary-100`}>
                        Browsers require user interaction before they will play
                    ...
                    >
                        ...
                        {Object.keys(consumerMap).map((k) => {
                            const { consumer, volume: userVolume } =
                                consumerMap[k];
                            return (
                                <MyAudio
                                    volume={
