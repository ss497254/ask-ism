...
import { AnsChatMessage, useAnsChatStore } from "./chat/useAnsChatStore";
...
const UserPreview = ({
    ...
    const bannedUserIdMap = useAnsChatStore((s) => s.bannedUserIdMap);
    ...
    if ("error" in data) {
        ...
        let errorMessage = ".viewUser.errors.default";

        switch (error) {
            case "blocked":
                errorMessage = ".viewUser.errors.blocked";
                break;
        }
    ...
    const buttonData = [
        [
            ...
            ".modals.profileModal.makeAnsCreator",
        ],
        [
            !isMe && iAmCreator,
            "makeMod",
            ...
            roomPermissions?.isMod
                ? ".modals.profileModal.unmod"
                : ".modals.profileModal.makeMod",
        ],
        [
            ...
            ".modals.profileModal.addAsSpeaker",
        ],
        [
            ...
            ".modals.profileModal.moveToListener",
        ],
        [
            canDoModStuffOnThisUser &&
            ...
            ".modals.profileModal.banFromChat",
        ],
        [
            canDoModStuffOnThisUser &&
                id in bannedUserIdMap &&
            ...
            ".modals.profileModal.unBanFromChat",
        ],
        [
            ...
            ".modals.profileModal.banFromAns",
        ],
        [
            canDoModStuffOnThisUser && (iAmCreator || !roomPermissions?.isMod),
            "banIpFromAns",
            ...
            ".modals.profileModal.banIPFromAns",
        ],
        [
            isMe &&
                !iAmCreator &&
            ...
            ".modals.profileModal.goBackToListener",
        ],
        [
            !!message,
            "deleteMessage",
            ...
            ".modals.profileModal.deleteMessage",
        ],
    ];
